...
// -----------------------------
    ...
    Shader lightingShader("colors.vs", "MultipleLightsShader.fs"); // you can name your shader files however you like
    ...
    unsigned int specularMap = loadTexture("Assets/Texture/container2.png");
